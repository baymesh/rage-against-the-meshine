...
export const DISCORD_CHANNEL_MF = process.env["DISCORD_CHANNEL_MF"];
export const DISCORD_CHANNEL_MF_TEST = process.env["DISCORD_CHANNEL_MF_TEST"];
export const DISCORD_CHANNEL_HAB = process.env["DISCORD_CHANNEL_HAB"];
export const DISCORD_CHAMMEL_HAMVENTION =
  process.env["DISCORD_CHAMMEL_HAMVENTION"];
